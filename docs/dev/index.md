...
* [Docusaurus](https://docusaurus.io/) SSG
  * i created my personal web site with Docusaurus
- MkDocs
- Hugo
...
- Static badges like the used by github and npm:  [shields.io](https://shields.io/)
